...
var $author$project$Number$applyExponent = F2(
	function (coefficient, e) {
		return coefficient * A2($elm$core$Basics$pow, 10, e);
	});
var $author$project$Number$sign = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$parser$Parser$map,
...
var $author$project$Number$exponent = A2(
...
var $author$project$Number$maybeExponentiate = function (number) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				$elm$parser$Parser$map,
				$author$project$Number$applyExponent(number),
				$author$project$Number$exponent),
				$elm$parser$Parser$succeed(number)
			]));
};
var $author$project$Number$parseNumber = A2($elm$parser$Parser$andThen, $author$project$Number$maybeExponentiate, $elm$parser$Parser$float);
...
var $author$project$Operation$fixPrecision = F2(
	function (p, value) {
		var multiplier = A2($elm$core$Basics$pow, 10, p);
		var correct = A2($pilatch$flip$Flip$flip, $elm$core$Basics$fdiv, multiplier);
		return correct(
			$elm$core$Basics$round(value * multiplier));
	});
...
var $author$project$Operation$precision = function (_float) {
...
var $author$project$Operation$multiply = F2(
	function (x, y) {
		return A2(
			$author$project$Operation$fixPrecision,
			$author$project$Operation$precision(x) + $author$project$Operation$precision(y),
			x * y);
	});
	...
	function (operation, x, y) {
		switch (operation) {
			...
			case 1:
				return x - y;
			case 2:
				return A2($author$project$Operation$multiply, x, y);
			default:
				return x / y;
		}
	});
			...
			if (!_v1.$) {
				...
				return _Utils_update(
					model,
					{
						...
						C: $elm$core$String$fromFloat(evaluation)
					});
			} else {
				return model;
			}
